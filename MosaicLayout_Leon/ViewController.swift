...
//  MosaicLayout_Leon
//
//  Created by lai leon on 2017/12/6.
...
class ViewController: UIViewController {
    ...
    let images = ["back", "birds", "sunset", "waves"]
    ...
    let collectionView: UICollectionView = {
        ...
        let collectionView = UICollectionView(frame: YHRect, collectionViewLayout: collectionLayout)
